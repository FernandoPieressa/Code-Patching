...
if	(	next	=	=	null	)	{	
RxJavaPlugins	.	onError	(	new	NullPointerException	(	"str"	)	)	;	
return	false	;	
}	
if	(	current	!	=	null	)	{	
next	.	cancel	(	)	;	
...
if	(	n	<	=	0	)	{	
RxJavaPlugins	.	onError	(	new	IllegalArgumentException	(	"str"	+	n	)	)	;	
return	false	;	
}	
return	true	;	
}	
...
RxJavaPlugins	.	onError	(	new	ProtocolViolationException	(	"str"	+	n	)	)	;	
}	
...
long	r	=	requested	.	getAndSet	(	0	L	)	;	
if	(	r	!	=	0	L	)	{	
s	.	request	(	r	)	;	
}	
return	true	;	
